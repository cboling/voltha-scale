...
#docker-compose -f /home/seba/compose/docker-compose-min-system-test.yml up -d
#docker-compose -f /home/seba/compose/docker-compose-local-auth-test.yml up -d onos
